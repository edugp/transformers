...
""" Testing suite for the PyTorch Data2Vec model. """
...
class Data2VecModelTester:
    ...
    def check_ctc_loss(self, config, input_values, *args):
        model = Data2VecForCTC(config=config)
        model.to(torch_device)
    ...
    def check_seq_classifier_loss(self, config, input_values, *args):
        model = Data2VecForSequenceClassification(config=config)
        model.to(torch_device)
    ...
    def check_xvector_training(self, config, input_values, *args):
        config.ctc_zero_infinity = True
        model = Data2VecForXVector(config=config)
        model.to(torch_device)
        model.train()
...
class Data2VecModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    # Data2Vec cannot resize token embeddings
    ...
    def test_mask_feature_prob_ctc(self):
        model = Data2VecForCTC.from_pretrained(
            "hf-internal-testing/tiny-random-data2vec", mask_feature_prob=0.2, mask_feature_length=2
        )
        model.to(torch_device).train()
        processor = Wav2Vec2Processor.from_pretrained(
            "hf-internal-testing/tiny-random-data2vec", return_attention_mask=True
        )
    ...
    def test_mask_time_prob_ctc(self):
        model = Data2VecForCTC.from_pretrained(
            "hf-internal-testing/tiny-random-data2vec", mask_time_prob=0.2, mask_time_length=2
        )
        model.to(torch_device).train()
        processor = Wav2Vec2Processor.from_pretrained(
            "hf-internal-testing/tiny-random-data2vec", return_attention_mask=True
...
@require_torch
class Data2VecRobustModelTest(ModelTesterMixin, unittest.TestCase):
    all_model_classes = (
        (
            Data2VecForCTC,
            Data2VecModel,
    ...
    def setUp(self):
        self.model_tester = Data2VecModelTester(
    ...
    def test_model_for_pretraining(self):
        config, inputs_dict = self.model_tester.prepare_config_and_inputs_for_common()
        model = Data2VecForPreTraining(config).to(torch_device)
    ...
    def test_mask_time_feature_prob_ctc_single_batch(self):
        model = Data2VecForCTC.from_pretrained(
            "hf-internal-testing/tiny-random-data2vec",
            mask_time_prob=0.2,
...
@require_torch
class Data2VecUtilsTest(unittest.TestCase):
    ...
    def test_compute_perplexity(self):
        ...
        ppl = Data2VecGumbelVectorQuantizer._compute_perplexity(probs)
        ...
        ppl = Data2VecGumbelVectorQuantizer._compute_perplexity(probs, mask)
...
@require_soundfile
@slow
class Data2VecModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_ctc_normal(self):
        model = Data2VecForCTC.from_pretrained("data2vec")
        model.to(torch_device)
        processor = Wav2Vec2Processor.from_pretrained("data2vec", do_lower_case=True)
    ...
    def test_inference_ctc_robust_batched(self):
        model = Data2VecForCTC.from_pretrained("facebook/data2vec-large-960h-lv60-self").to(torch_device)
        processor = Wav2Vec2Processor.from_pretrained("facebook/data2vec-large-960h-lv60-self", do_lower_case=True)
    ...
    def test_inference_integration(self):
        model = Data2VecForPreTraining.from_pretrained("facebook/data2vec-base")
        model.to(torch_device)
        feature_extractor = Wav2Vec2FeatureExtractor.from_pretrained("facebook/data2vec-base")
        input_speech = self._load_datasamples(2)
    ...
    def test_inference_pretrained(self):
        ...
        feature_extractor = Wav2Vec2FeatureExtractor.from_pretrained(
            "facebook/data2vec-base", return_attention_mask=True
        )
        input_speech = self._load_datasamples(2)
        ...
        config = Data2VecConfig.from_pretrained("facebook/data2vec-base")
        model_rand = Data2VecForPreTraining(config).to(torch_device).eval()
        ...
        # a pretrained data2vec model has learned to predict the quantized latent states
        # => the cosine similarity between quantized states and predicted states > 0.5
        # a random data2vec model has not learned to predict the quantized latent states
        # => the cosine similarity between quantized states and predicted states is very likely < 0.1
        self.assertTrue(cosine_sim_masked.mean().item() - 5 * cosine_sim_masked_rand.mean().item() > 0)

    @unittest.skipIf(torch_device != "cpu", "cannot make deterministic on GPU")
    def test_loss_pretraining(self):
        model = Data2VecForPreTraining.from_pretrained(
            "facebook/data2vec-base",
    ...
    def test_inference_keyword_spotting(self):
        model = Data2VecForSequenceClassification.from_pretrained("superb/data2vec-base-superb-ks").to(torch_device)
        processor = Wav2Vec2FeatureExtractor.from_pretrained("superb/data2vec-base-superb-ks")
    ...
    def test_inference_intent_classification(self):
        model = Data2VecForSequenceClassification.from_pretrained("superb/data2vec-base-superb-ic").to(torch_device)
        processor = Wav2Vec2FeatureExtractor.from_pretrained("superb/data2vec-base-superb-ic")
    ...
    def test_inference_speaker_identification(self):
        model = Data2VecForSequenceClassification.from_pretrained("superb/data2vec-base-superb-sid").to(torch_device)
        processor = Wav2Vec2FeatureExtractor.from_pretrained("superb/data2vec-base-superb-sid")
    ...
    def test_inference_emotion_recognition(self):
        model = Data2VecForSequenceClassification.from_pretrained("superb/data2vec-base-superb-er").to(torch_device)
        processor = Wav2Vec2FeatureExtractor.from_pretrained("superb/data2vec-base-superb-er")
    ...
    def test_phoneme_recognition(self):
        model = Data2VecForCTC.from_pretrained("facebook/data2vec-lv-60-espeak-cv-ft").to(torch_device)
        processor = Wav2Vec2Processor.from_pretrained("facebook/data2vec-lv-60-espeak-cv-ft")
    ...
    @require_pyctcdecode
    @require_torchaudio
    def test_data2vec_with_lm(self):
        ...
        model = Data2VecForCTC.from_pretrained("patrickvonplaten/data2vec-large-xlsr-53-spanish-with-lm").to(
            torch_device
        )
        processor = Wav2Vec2ProcessorWithLM.from_pretrained("patrickvonplaten/data2vec-large-xlsr-53-spanish-with-lm")
    ...
    def test_inference_diarization(self):
        model = Data2VecForAudioFrameClassification.from_pretrained("anton-l/data2vec-base-superb-sd").to(torch_device)
        processor = Wav2Vec2FeatureExtractor.from_pretrained("anton-l/data2vec-base-superb-sd")
    ...
    def test_inference_speaker_verification(self):
        model = Data2VecForXVector.from_pretrained("anton-l/data2vec-base-superb-sv").to(torch_device)
        processor = Wav2Vec2FeatureExtractor.from_pretrained("anton-l/data2vec-base-superb-sv")
        input_data = self._load_superb("si", 4)
