...
if is_flax_available():
    ...
    from transformers.models.data2vec.modeling_flax_data2vec import (
        ...
        FlaxData2VecGumbelVectorQuantizer,
        FlaxData2VecModel,
...
class FlaxData2VecModelTest(FlaxModelTesterMixin, unittest.TestCase):
    all_model_classes = (
        (FlaxData2VecModel, FlaxData2VecForCTC, FlaxData2VecForPreTraining) if is_flax_available() else ()
    )
    ...
    def test_train(self):
        ...
        model = FlaxData2VecForPreTraining(config)
    ...
    def test_model_from_pretrained(self):
        for model_class_name in self.all_model_classes:
            model = model_class_name.from_pretrained("facebook/data2vec-large-960h-lv60-self", from_pt=True)
            outputs = model(np.ones((1, 1024), dtype="f4"))
            self.assertIsNotNone(outputs)


@require_flax
class FlaxData2VecUtilsTest(unittest.TestCase):
    ...
    def test_compute_perplexity(self):
        ...
        ppl = FlaxData2VecGumbelVectorQuantizer._compute_perplexity(probs)
        ...
        ppl = FlaxData2VecGumbelVectorQuantizer._compute_perplexity(probs, mask)
...
@require_soundfile
@slow
class FlaxData2VecModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_ctc_robust_batched(self):
        model = FlaxData2VecForCTC.from_pretrained("facebook/data2vec-large-960h-lv60-self", from_pt=True)
    ...
    def test_inference_pretrained(self):
        model = FlaxData2VecForPreTraining.from_pretrained("facebook/data2vec-large-lv60", from_pt=True)
        feature_extractor = Wav2Vec2FeatureExtractor.from_pretrained(
            "facebook/data2vec-large-lv60", return_attention_mask=True
        )
        ...
        config = Data2VecConfig.from_pretrained("facebook/data2vec-large-lv60")
        model_rand = FlaxData2VecForPreTraining(config)
    ...
    def test_data2vec_with_lm(self):
        ...
        model = FlaxData2VecForCTC.from_pretrained("patrickvonplaten/data2vec-large-xlsr-53-spanish-with-lm")
